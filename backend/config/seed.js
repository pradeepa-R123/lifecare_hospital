...
const HOSPITAL = {
  ...
  location: { latitude: 13.0604, longitude: 80.2496, mapUrl: "https://maps.google.com/?q=Anna+Salai+Chennai" },
  departments: [
    ...
    { name: "Pediatrics",  icon: "👶",  description: "Expert child healthcare and pediatric surgery" },
  ],
...
const DOCTORS = [
  { name:"Dr. Ravi",   email:"ravi@lifecare.com",   department:"Cardiology",  specialization:"Interventional Cardiology",   experience:"16 yrs", education:"MBBS, DM",  studiedAt:"AIIMS Delhi" },
  { name:"Dr. Ramesh", email:"ramesh@lifecare.com", department:"Neurology",   specialization:"Neurosurgery",                experience:"11 yrs", education:"MBBS, DM",  studiedAt:"CMC Vellore" },
  { name:"Dr. Meena",  email:"meena@lifecare.com",  department:"Orthopedics", specialization:"Joint Replacement Surgery",   experience:"10 yrs", education:"MBBS, MS",  studiedAt:"JIPMER Puducherry" },
  { name:"Dr. Suresh", email:"suresh@lifecare.com", department:"Emergency",   specialization:"Emergency & Trauma Medicine", experience:"8 yrs",  education:"MBBS, MD",  studiedAt:"Madras Medical College" },
  { name:"Dr. Priya",  email:"priya@lifecare.com",  department:"Pediatrics",  specialization:"Pediatric Surgery",           experience:"7 yrs",  education:"MBBS, DCH", studiedAt:"SRMC Chennai" },
];
...
const BLOOD_BANKS = [{
  name: "LifeCare Blood Bank", location: "T. Nagar, Chennai",
  phone: "+91-44-2345-6700", status: "Open 24/7",
  stock: { A_pos:0, A_neg:0, B_pos:0, B_neg:0, O_pos:0, O_neg:0, AB_pos:0, AB_neg:0 },
}];
